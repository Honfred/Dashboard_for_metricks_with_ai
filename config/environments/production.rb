...
Rails.application.configure do
  ...
  # Use Redis cache store in production (db 1 to avoid collision with Sidekiq on db 0).
  ...
  # config.active_job.queue_name_prefix = "dashboard_for_metricks_with_ai_production"
